<template>
  ...
  <div class="container grid-xl">
    <section>
      ...
      <p><a href="https://github.com/axios/axios">Axios HTTP client</a> is integrated with a barebones base config at <code>/src/http-common.js</code>.<br>See this component's <code>getPosts()</code> method at <code>/src/pages/HelloWorld.vue</code> for an example on how to do API requests.</p>
